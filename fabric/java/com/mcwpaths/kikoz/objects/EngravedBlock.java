...
public class EngravedBlock extends PathBlock {

	public static final BooleanProperty ENGRAVED = BooleanProperty.of("engraved");
	...
	public EngravedBlock(Settings properties) {
		super(properties);
		this.setDefaultState((BlockState)this.getDefaultState().with(ENGRAVED, false));
	}

	@Override
	public VoxelShape getOutlineShape(BlockState state, BlockView reader, BlockPos pos, ShapeContext context) {
		boolean engraved = state.get(ENGRAVED);
