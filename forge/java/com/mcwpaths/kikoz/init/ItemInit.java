...
public class ItemInit {
	...
	public static final RegistryObject<Item> DARK_PRISMARINE_RUNNING_BOND_PATH = ITEMS.register("dark_prismarine_running_bond_path", () -> new BlockItem(BlockInit.DARK_PRISMARINE_RUNNING_BOND_PATH.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SAND_PATH_BLOCK = ITEMS.register("sand_path_block", () -> new FlattenedBlockTooltip(BlockInit.SAND_PATH_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_SAND_PATH_BLOCK = ITEMS.register("red_sand_path_block", () -> new FlattenedBlockTooltip(BlockInit.RED_SAND_PATH_BLOCK.get(), new Item.Properties()));

	public static final RegistryObject<Item> ANDESITE_RUNNING_BOND_STAIRS = ITEMS.register("andesite_running_bond_stairs", () -> new BlockItem(BlockInit.ANDESITE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DIORITE_RUNNING_BOND_STAIRS = ITEMS.register("diorite_running_bond_stairs", () -> new BlockItem(BlockInit.DIORITE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> GRANITE_RUNNING_BOND_STAIRS = ITEMS.register("granite_running_bond_stairs", () -> new BlockItem(BlockInit.GRANITE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> SANDSTONE_RUNNING_BOND_STAIRS = ITEMS.register("sandstone_running_bond_stairs", () -> new BlockItem(BlockInit.SANDSTONE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_SANDSTONE_RUNNING_BOND_STAIRS = ITEMS.register("red_sandstone_running_bond_stairs", () -> new BlockItem(BlockInit.RED_SANDSTONE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BRICK_RUNNING_BOND_STAIRS = ITEMS.register("brick_running_bond_stairs", () -> new BlockItem(BlockInit.BRICK_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> STONE_RUNNING_BOND_STAIRS = ITEMS.register("stone_running_bond_stairs", () -> new BlockItem(BlockInit.STONE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MOSSY_STONE_RUNNING_BOND_STAIRS = ITEMS.register("mossy_stone_running_bond_stairs", () -> new BlockItem(BlockInit.MOSSY_STONE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_RUNNING_BOND_STAIRS = ITEMS.register("cobbled_deepslate_running_bond_stairs", () -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DEEPSLATE_RUNNING_BOND_STAIRS = ITEMS.register("deepslate_running_bond_stairs", () -> new BlockItem(BlockInit.DEEPSLATE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MUD_BRICK_RUNNING_BOND_STAIRS = ITEMS.register("mud_brick_running_bond_stairs", () -> new BlockItem(BlockInit.MUD_BRICK_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BLACKSTONE_RUNNING_BOND_STAIRS = ITEMS.register("blackstone_running_bond_stairs", () -> new BlockItem(BlockInit.BLACKSTONE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DARK_PRISMARINE_RUNNING_BOND_STAIRS = ITEMS.register("dark_prismarine_running_bond_stairs", () -> new BlockItem(BlockInit.DARK_PRISMARINE_RUNNING_BOND_STAIRS.get(), new Item.Properties()));

	public static final RegistryObject<Item> ANDESITE_WINDMILL_WEAVE_STAIRS = ITEMS.register("andesite_windmill_weave_stairs", () -> new BlockItem(BlockInit.ANDESITE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DIORITE_WINDMILL_WEAVE_STAIRS = ITEMS.register("diorite_windmill_weave_stairs", () -> new BlockItem(BlockInit.DIORITE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> GRANITE_WINDMILL_WEAVE_STAIRS = ITEMS.register("granite_windmill_weave_stairs", () -> new BlockItem(BlockInit.GRANITE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> SANDSTONE_WINDMILL_WEAVE_STAIRS = ITEMS.register("sandstone_windmill_weave_stairs", () -> new BlockItem(BlockInit.SANDSTONE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_SANDSTONE_WINDMILL_WEAVE_STAIRS = ITEMS.register("red_sandstone_windmill_weave_stairs", () -> new BlockItem(BlockInit.RED_SANDSTONE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BRICK_WINDMILL_WEAVE_STAIRS = ITEMS.register("brick_windmill_weave_stairs", () -> new BlockItem(BlockInit.BRICK_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> STONE_WINDMILL_WEAVE_STAIRS = ITEMS.register("stone_windmill_weave_stairs", () -> new BlockItem(BlockInit.STONE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MOSSY_STONE_WINDMILL_WEAVE_STAIRS = ITEMS.register("mossy_stone_windmill_weave_stairs", () -> new BlockItem(BlockInit.MOSSY_STONE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_WINDMILL_WEAVE_STAIRS = ITEMS.register("cobbled_deepslate_windmill_weave_stairs", () -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DEEPSLATE_WINDMILL_WEAVE_STAIRS = ITEMS.register("deepslate_windmill_weave_stairs", () -> new BlockItem(BlockInit.DEEPSLATE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MUD_BRICK_WINDMILL_WEAVE_STAIRS = ITEMS.register("mud_brick_windmill_weave_stairs", () -> new BlockItem(BlockInit.MUD_BRICK_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BLACKSTONE_WINDMILL_WEAVE_STAIRS = ITEMS.register("blackstone_windmill_weave_stairs", () -> new BlockItem(BlockInit.BLACKSTONE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DARK_PRISMARINE_WINDMILL_WEAVE_STAIRS = ITEMS.register("dark_prismarine_windmill_weave_stairs", () -> new BlockItem(BlockInit.DARK_PRISMARINE_WINDMILL_WEAVE_STAIRS.get(), new Item.Properties()));

	public static final RegistryObject<Item> ANDESITE_FLAGSTONE_STAIRS = ITEMS.register("andesite_flagstone_stairs", () -> new BlockItem(BlockInit.ANDESITE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DIORITE_FLAGSTONE_STAIRS = ITEMS.register("diorite_flagstone_stairs", () -> new BlockItem(BlockInit.DIORITE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> GRANITE_FLAGSTONE_STAIRS = ITEMS.register("granite_flagstone_stairs", () -> new BlockItem(BlockInit.GRANITE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> SANDSTONE_FLAGSTONE_STAIRS = ITEMS.register("sandstone_flagstone_stairs", () -> new BlockItem(BlockInit.SANDSTONE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_SANDSTONE_FLAGSTONE_STAIRS = ITEMS.register("red_sandstone_flagstone_stairs", () -> new BlockItem(BlockInit.RED_SANDSTONE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BRICK_FLAGSTONE_STAIRS = ITEMS.register("brick_flagstone_stairs", () -> new BlockItem(BlockInit.BRICK_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> STONE_FLAGSTONE_STAIRS = ITEMS.register("stone_flagstone_stairs", () -> new BlockItem(BlockInit.STONE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MOSSY_STONE_FLAGSTONE_STAIRS = ITEMS.register("mossy_stone_flagstone_stairs", () -> new BlockItem(BlockInit.MOSSY_STONE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_FLAGSTONE_STAIRS = ITEMS.register("cobbled_deepslate_flagstone_stairs", () -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DEEPSLATE_FLAGSTONE_STAIRS = ITEMS.register("deepslate_flagstone_stairs", () -> new BlockItem(BlockInit.DEEPSLATE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MUD_BRICK_FLAGSTONE_STAIRS = ITEMS.register("mud_brick_flagstone_stairs", () -> new BlockItem(BlockInit.MUD_BRICK_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BLACKSTONE_FLAGSTONE_STAIRS = ITEMS.register("blackstone_flagstone_stairs", () -> new BlockItem(BlockInit.BLACKSTONE_FLAGSTONE_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DARK_PRISMARINE_FLAGSTONE_STAIRS = ITEMS.register("dark_prismarine_flagstone_stairs", () -> new BlockItem(BlockInit.DARK_PRISMARINE_FLAGSTONE_STAIRS.get(), new Item.Properties()));

	public static final RegistryObject<Item> ANDESITE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("andesite_crystal_floor_stairs", () -> new BlockItem(BlockInit.ANDESITE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DIORITE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("diorite_crystal_floor_stairs", () -> new BlockItem(BlockInit.DIORITE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> GRANITE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("granite_crystal_floor_stairs", () -> new BlockItem(BlockInit.GRANITE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> SANDSTONE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("sandstone_crystal_floor_stairs", () -> new BlockItem(BlockInit.SANDSTONE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_SANDSTONE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("red_sandstone_crystal_floor_stairs", () -> new BlockItem(BlockInit.RED_SANDSTONE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> BRICK_CRYSTAL_FLOOR_STAIRS = ITEMS.register("brick_crystal_floor_stairs", () -> new BlockItem(BlockInit.BRICK_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> STONE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("stone_crystal_floor_stairs", () -> new BlockItem(BlockInit.STONE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MOSSY_STONE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("mossy_stone_crystal_floor_stairs", () -> new BlockItem(BlockInit.MOSSY_STONE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("cobbled_deepslate_crystal_floor_stairs", () -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> DEEPSLATE_CRYSTAL_FLOOR_STAIRS = ITEMS.register("deepslate_crystal_floor_stairs", () -> new BlockItem(BlockInit.DEEPSLATE_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
	public static final RegistryObject<Item> MUD_BRICK_CRYSTAL_FLOOR_STAIRS = ITEMS.register("mud_brick_crystal_floor_stairs", () -> new BlockItem(BlockInit.MUD_BRICK_CRYSTAL_FLOOR_STAIRS.get(), new Item.Properties()));
