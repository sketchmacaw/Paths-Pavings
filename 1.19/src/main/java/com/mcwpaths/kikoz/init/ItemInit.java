...
public class ItemInit {
	...
	public static final RegistryObject<Item> MANGROVE_PLANKS_PATH = ITEMS.register("mangrove_planks_path",() -> new FuelItemBlock(BlockInit.MANGROVE_PLANKS_PATH.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	...
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_DIAMOND_PAVING = ITEMS.register("cobbled_deepslate_diamond_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_DIAMOND_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_BASKET_WEAVE_PAVING = ITEMS.register("cobbled_deepslate_basket_weave_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_BASKET_WEAVE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_SQUARE_PAVING = ITEMS.register("cobbled_deepslate_square_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_SQUARE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_HONEYCOMB_PAVING = ITEMS.register("cobbled_deepslate_honeycomb_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_HONEYCOMB_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_CLOVER_PAVING = ITEMS.register("cobbled_deepslate_clover_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_CLOVER_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> COBBLED_DEEPSLATE_DUMBLE_PAVING = ITEMS.register("cobbled_deepslate_dumble_paving",() -> new BlockItem(BlockInit.COBBLED_DEEPSLATE_DUMBLE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));

	public static final RegistryObject<Item> DEEPSLATE_DIAMOND_PAVING = ITEMS.register("deepslate_diamond_paving",() -> new BlockItem(BlockInit.DEEPSLATE_DIAMOND_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> DEEPSLATE_BASKET_WEAVE_PAVING = ITEMS.register("deepslate_basket_weave_paving",() -> new BlockItem(BlockInit.DEEPSLATE_BASKET_WEAVE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> DEEPSLATE_SQUARE_PAVING = ITEMS.register("deepslate_square_paving",() -> new BlockItem(BlockInit.DEEPSLATE_SQUARE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> DEEPSLATE_HONEYCOMB_PAVING = ITEMS.register("deepslate_honeycomb_paving",() -> new BlockItem(BlockInit.DEEPSLATE_HONEYCOMB_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> DEEPSLATE_CLOVER_PAVING = ITEMS.register("deepslate_clover_paving",() -> new BlockItem(BlockInit.DEEPSLATE_CLOVER_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> DEEPSLATE_DUMBLE_PAVING = ITEMS.register("deepslate_dumble_paving",() -> new BlockItem(BlockInit.DEEPSLATE_DUMBLE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));

	public static final RegistryObject<Item> MUD_BRICK_DIAMOND_PAVING = ITEMS.register("mud_brick_diamond_paving",() -> new BlockItem(BlockInit.MUD_BRICK_DIAMOND_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> MUD_BRICK_BASKET_WEAVE_PAVING = ITEMS.register("mud_brick_basket_weave_paving",() -> new BlockItem(BlockInit.MUD_BRICK_BASKET_WEAVE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> MUD_BRICK_SQUARE_PAVING = ITEMS.register("mud_brick_square_paving",() -> new BlockItem(BlockInit.MUD_BRICK_SQUARE_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
	public static final RegistryObject<Item> MUD_BRICK_HONEYCOMB_PAVING = ITEMS.register("mud_brick_honeycomb_paving",() -> new BlockItem(BlockInit.MUD_BRICK_HONEYCOMB_PAVING.get(), new Item.Properties().tab(MacawsPaths.PathsItemGroup)));
