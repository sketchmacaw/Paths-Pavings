...
public class ClientEventBusSubscriber {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MANGROVE_PLANKS_PATH.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_DIAMOND_PAVING.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_BASKET_WEAVE_PAVING.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_SQUARE_PAVING.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_HONEYCOMB_PAVING.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_CLOVER_PAVING.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(BlockInit.MUD_BRICK_DUMBLE_PAVING.get(), RenderType.cutout());
